...
const Header = () => {
    const {dark,setDark,user,signOutUser,loading} = useContext(mainContext)

    return (
        <div className="navbar lg:w-10/12 mx-auto relative">
            {loading && <div className="w-16 h-16 border-4 border-dashed rounded-full animate-spin border-violet-400 absolute left-[48%] top-24 " bis_skin_checked="1"></div>}
