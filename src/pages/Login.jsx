...
const Login = () => {
    ...
    return (
        <div className='flex justify-center my-5 h-[70vh] items-center'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100" bis_skin_checked="1">
